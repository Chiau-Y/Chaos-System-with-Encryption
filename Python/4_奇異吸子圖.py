...
plt.figure(1)
plt.subplot(331) # y1 vs x1
plt.plot(y11,x11,color='#ff8c00')
plt.xlabel('y1')
plt.ylabel('x1')
plt.subplot(332) # y1 vs x2
plt.plot(y11,x22,color='#ff8c00')
plt.xlabel('y1')
plt.ylabel('x2')
plt.subplot(333) # y1 vs x3
plt.plot(y11,x33,color='#ff8c00')
plt.xlabel('y1')
plt.ylabel('x3')
plt.subplot(334) # y2 vs x1
plt.plot(y22,x11)
plt.xlabel('y2')
plt.ylabel('x1')
plt.subplot(335) # y2 vs x2
plt.plot(y22,x22)
plt.xlabel('y2')
plt.ylabel('x2')
plt.subplot(336) # y2 vs x3
plt.plot(y22,x33)
plt.xlabel('y2')
plt.ylabel('x3')
plt.subplot(337) # y3 vs x1
plt.plot(y33,x11,color='#db7093')
plt.xlabel('y3')
plt.ylabel('x1')
plt.subplot(338) # y3 vs x2
plt.plot(y33,x22,color='#db7093')
plt.xlabel('y3')
plt.ylabel('x2')
plt.subplot(339) # y3 vs x3
plt.plot(y33,x33,color='#db7093')
plt.xlabel('y3')
plt.ylabel('x3')
plt.show()
